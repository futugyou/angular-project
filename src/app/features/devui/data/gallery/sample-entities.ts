...
export const SAMPLE_ENTITIES: SampleEntity[] = [
  // Beginner Agents
  {
    ...
    description: 'Weather agent using Azure AI Agent (Foundry) with Azure CLI authentication',
    type: 'agent',
    ...
    author: 'Microsoft',
    difficulty: 'beginner',
    features: ['Azure AI Agent integration', 'Azure CLI authentication', 'Mock weather tools'],
    requiredEnvVars: [
      {
...

  {
    ...
    description: 'Weather agent using Azure OpenAI with API key authentication',
    type: 'agent',
  ...
  // Beginner Workflows
  {
    ...
    description: '5-step workflow demonstrating email spam detection with branching logic',
    type: 'workflow',
    ...
    author: 'Microsoft',
    difficulty: 'beginner',
    features: ['Sequential execution', 'Conditional branching', 'Mock spam detection'],
  },

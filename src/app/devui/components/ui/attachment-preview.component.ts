    ...
    >
      <ng-container [ngSwitch]="attachment.type">
        <ng-container *ngSwitchCase="'image'">
          <img
            *ngIf="attachment.preview; else noImage"
        ...
        <div
          *ngSwitchCase="'pdf'"
          class="flex flex-col items-center justify-center w-full h-full bg-red-50"
        >
        ...
        <div
          *ngSwitchCase="'audio'"
          class="flex flex-col items-center justify-center w-full h-full bg-purple-50"
        >
        ...
        <div
          *ngSwitchDefault
          class="flex flex-col items-center justify-center w-full h-full bg-gray-100"
        >
...
export class AttachmentPreviewComponent {
  @Input({ required: true }) attachment!: AttachmentItem
